package com.Clinica1.myApp.IAMusuario.interfaces.exception;
...
class GlobalExceptionHandlerTest {
        ...
        void testGlobalExceptionHandlerCompleto() throws Exception {
                ...
                ResponseEntity<Map<String, Object>> response1 = handler.handleValidationErrors(manve);
                ...
                CredencialesInvalidasException credEx = new CredencialesInvalidasException(
                                "UsuarioWeb o contraseña incorrectos");

                ResponseEntity<Map<String, Object>> response2 = handler.handleCredencialesInvalidas(credEx);
                ...
                ResponseEntity<Map<String, Object>> response3 = handler.handleGeneric(genericEx);
